        ...
        <div className="edit-book">
            ...
            <form id="bookEditForm" className="form-default" onSubmit={handleSubmit(editBook)}>
                ...
                <div className="label-input-pair">
                    ...
                    <input type="text" id="image" name="image" className="input-default input-inside" {...register("image")} />
                </div>

                <div className="label-input-pair">
                    <label htmlFor="genre" className="text-inside">Genre:</label>
                    <input type="text" id="genre" name="genre" className="input-default input-inside" {...register("genre")} />
                </div>

                <div className="label-input-pair">
                    <label htmlFor="deposit" className="text-inside">Deposit:</label>
                    <input type="number" id="deposit" name="deposit" className="input-default input-inside" {...register("deposit")} />
                </div>

                <div className="label-input-pair">
                    <label htmlFor="day_price" className="text-inside">Day Price:</label>
                    <input type="number" id="day_price" name="day_price" className="input-default input-inside" {...register("dayPrice")} />
                </div>

                <div className="label-input-pair">
                    <label htmlFor="discount" className="text-inside">Discount:</label>
                    <input type="number" id="discount" name="discount" className="input-default input-inside" {...register("discount")} />
                </div>
                ...
                <div className="label-input-pair">
                    ...
                    <input type="text" id="state" name="state" className="input-default input-inside" {...register("bookState")} />
                </div>

                <div className="label-input-pair">
                    <label htmlFor="authorId" className="text-inside">Author:</label>
                    <input type="number" id="authorId" name="authorId" className="input-default input-inside" {...register("author")} />
                </div>
